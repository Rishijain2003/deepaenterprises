...
export function AudioVideoPage() {
  ...
  const audioVideoProducts = products.filter(product => product.category === 'Audio & Video');
  
  const subcategories = [...new Set(audioVideoProducts.map(product => product.subcategory))];

  const filteredAndSortedProducts = useMemo(() => {
    let filtered = audioVideoProducts;
  ...
  }, [audioVideoProducts, sortBy, filterBy]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[#003366] to-[#004080] text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Audio & Video</h1>
            <p className="text-xl text-gray-200">
              Experience premium sound and visual entertainment with our cutting-edge audio and video systems
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-600">
          ...
          <span className="text-gray-900">Audio & Video</span>
        </nav>
      </div>
            ...
            {subcategories.map((subcategory) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  {audioVideoProducts.filter(p => p.subcategory === subcategory).length} products
                </p>
              </Link>
            ))}
          </div>
